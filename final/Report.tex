...
players in the tournament. The referee, scheduler and ranker will be explained
in detail in section \ref{sec:impl-tab-components}. \\
...
screenshot of the page after clicking the tab can be seen in
Figure \ref{fig:matches-student} in the Appendix, when logged in as a student,
and the page is the same for when logged in as an admin or when not logged in.
...
\url{https://git.cs.sun.ac.za/20703236/fscte}. All of the files present in the
repository take up 36 Megabytes of space and consist of $11 652$ lines of code.
Vue makes up 53.2\% of the code base, with Go making up 22\%, TypeScript making
up 19.4\%, Shell making up 4.1\%, Python making up 0.9\% and the rest of the
languages making up 0.4\% of the code base.
